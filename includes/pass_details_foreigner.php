...
if(isset($_POST['submit'])){
    ...
    if(   empty($_POST['mobile_number'])   ||  empty($_POST['card_number']) ){

		$message = '';
		
        if(     empty($_POST['mobile_number'])      ){

            $message .= 'Mobile Number can\'t be empty<br>';
        }
		...
		$query = sprintf("UPDATE tbl_pass_foreigner SET mobileNumber = '%s', visitorCardNo = '%s', visitorInTime = '%s', passStatus = '%s'
...
$sql_search = "SELECT * FROM tbl_pass_foreigner WHERE rowID = '" . $_REQUEST['passID'] . "'" ;
...
<table width="100%" >
	<tr>
		<td align="left" width="70%" valign="top">
			<h4>Foreigner Pass Details</h4>
            
	<table bordercolor="#006666" border="0"  width="100%"  >         <!--      bgcolor="#EEEEEC"       -->
	<tr>
    <td align="center" >
   
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>?action=pass_details_foreigner&passID=<?php echo $result_array[0]['rowID'];?>" method="post">
...
?>        
        ...
        <tr>
                  <td width="232" align="right"><strong>Country</strong></td>
                  <td align="center">:</td>
                  <td width="233"><?php echo $result_array[0]['visitorCountry'];?></td>                         
		          <td width="215">&nbsp;</td>
          <td width="6"></td>
          <td width="252"></td>
        </tr>       
          ...
          <td valign="top" align="left">
                 <?php 
				   if( ($result_array[0]['passStatus'] == 'open')&& ($_SESSION['_userType'] !=1 )){ 
					  ...
					  $_SESSION['visitorType'] = 'FV';  // Foreigner Visitor
...
<tr>
        ...
        <tr>
                  <td width="232" align="right"><strong>Scheduled Date</strong></td>
                  <td align="center">:</td>
                  <td><?php if (isset($result_array[0]['scheduledVisitDate'])) echo $result_array[0]['scheduledVisitDate'];?></td>
                  <td>&nbsp;</td>
          <td>&nbsp;</td>
  <td>&nbsp;</td>
        </tr>
