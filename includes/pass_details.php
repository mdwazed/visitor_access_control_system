...
if(isset($_POST['submit'])){
    ...
    if(   (empty($_POST['mobile_number']) && empty($_POST['national_ID']))  ||  empty($_POST['card_number']) ){
		...
		$query = sprintf("UPDATE tbl_pass SET mobileNumber = '%s', nationalID = '%s', visitorCardNo = '%s', visitorInTime = '%s', passStatus = '%s'
...
$sql_search = "SELECT * FROM tbl_pass WHERE rowID = '" . $_REQUEST['passID'] . "'" ;
