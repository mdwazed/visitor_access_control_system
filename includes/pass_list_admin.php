	...
	<TR>
		<TD>	
            ...
            <?php
                    ...
                    $sql_search = "SELECT * FROM tbl_pass " . $where_clause . " ORDER BY  passStatus DESC LIMIT ".$offset.",".$rowsPerPage;
...
<?php		
            ...
            <?php
                    ...
                    for($page = 1; $page <= $maxPage; $page++)
                    {
                       ...
                       {
                          $nav .= " <a href=\"$self?action=view_pass_list_admin&page=$page\">$page</a> ";
                       } 
                    }
                    ...
                    {
                       $page  = $pageNum - 1;
                       $prev  = " <a href=\"$self?action=view_pass_list_admin&page=$page\">[Prev]</a> ";
                    
                       $first = " <a href=\"$self?action=view_pass_list_admin&page=1\">[First Page]</a> ";
                    } 
                    else
                    {
                    ...
                    {
                       $page = $pageNum + 1;
                       $next = " <a href=\"$self?action=view_pass_list_admin&page=$page\">[Next]</a> ";
                    
                       $last = " <a href=\"$self?action=view_pass_list_admin&page=$maxPage\">[Last Page]</a> ";
                    } 
                    else
                    {
