...
function validateForm() {
	...
	if (document.getElementById('directorate_to_visit').value=="" && document.getElementById('pass_status').value==""){	

		if (document.getElementById('card_number').value=="" && document.getElementById('visitor_name').value=="" && document.getElementById('mobile_number').value==""  ) {
	
			alert("Please enter or select search criteria.");
			return false;
		}
	}
...
<tr valign="middle">
                           ...
                           <td width="15%"  bgcolor="#33CC33" align="center"><strong>Card Number </strong></td>
                            <td width="15%"  bgcolor="#33CC33" align="center"><strong>Visitor Name</strong></td>
                            <td width="15%"  bgcolor="#33CC33" align="center"><strong>Mobile Number</strong></td>
                            <td width="15%"  bgcolor="#33CC33"align="center"><strong>Directorate</strong></td>
                            <td width="15%"  bgcolor="#33CC33" align="center"><strong>Pass Status</strong></td>
                            <td width="15%" colspan="4"  bgcolor="#33CC33" align="center"><strong>&nbsp;</strong></td>
                            
</tr>

<form action="<?php echo $_SERVER['PHP_SELF']; ?>?action=search_pass_current" onsubmit="return validateForm()" method="post">
<tr valign="middle">

	<td width="15%"  bgcolor="#9999FF" align="center"><strong><input type="text" name="card_number" id="card_number" /></strong></td>
	
    <td width="15%"  bgcolor="#9999FF" align="center"><strong><input type="text" name="visitor_name" id="visitor_name" /></strong></td>
    
    <td width="15%"  bgcolor="#9999FF" align="center"><strong><input type="text" name="mobile_number" id="mobile_number" /></strong></td>
	...
	<td width="15%"  bgcolor="#9999FF" align="center"><strong><select name="pass_status" id="pass_status">
                      <option value="" selected>Please Select</option>
...
<!--                      <option value="closed">Closed</option>   -->                   
	...
	<td width="15%" colspan="4"  bgcolor="#9999FF" align="left"><strong><input type="submit" name="submit" value="Search Pass" /></strong></td>
...
?>						 
		...
		<tr>
			...
			?>
                            ...
                            <a href="<?php echo $_SERVER['PHP_SELF']; ?>?action=search_pass_current&page=<?php if(isset($_REQUEST['page'])) echo $_REQUEST['page']; else echo 1; 		 							?>&out=true&passID=<?php echo $result_array[$i]['rowID'];?>">Out</a>
		    <?php 
				   }
				   else{
				   		echo "N/A";
...
<?php
		...
		for($page = 1; $page <= $maxPage; $page++)
		{
		   ...
		   {
			  $nav .= " <a href=\"$self?action=search_pass_current&page=$page\">$page</a> ";
		   } 
		}
		...
		{
		   $page  = $pageNum - 1;
		   $prev  = " <a href=\"$self?action=search_pass_current&page=$page\">[Prev]</a> ";
		
		   $first = " <a href=\"$self?action=search_pass_current&page=1\">[First Page]</a> ";
		} 
		else
		{
		...
		{
		   $page = $pageNum + 1;
		   $next = " <a href=\"$self?action=search_pass_current&page=$page\">[Next]</a> ";
		
		   $last = " <a href=\"$self?action=search_pass_current&page=$maxPage\">[Last Page]</a> ";
		} 
		else
		{
