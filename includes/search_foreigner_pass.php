...
if(  isset($_REQUEST["out"]) && $_REQUEST["out"] == "true"){
		...
		$query = sprintf("UPDATE tbl_pass_foreigner SET visitorOutTime = '%s', passStatus = '%s'
...
<tr valign="middle">
                           ...
                           <td width="15%"  bgcolor="#996699" align="center"><strong>Card Number </strong></td>
                            <td width="15%"  bgcolor="#996699" align="center"><strong>Visitor Name</strong></td>
                            <td width="15%"  bgcolor="#996699" align="center"><strong>Directorate</strong></td>
                            <td width="15%"  bgcolor="#996699" align="center"><strong>Pass Status</strong></td>
                            <td width="15%" colspan="5"  bgcolor="#996699" align="center"><strong>&nbsp;</strong></td>
                            
</tr>

<form action="<?php echo $_SERVER['PHP_SELF']; ?>?action=search_foreigner_pass" method="post">
<tr valign="middle">
...
<tr>
                          ...
                          <tr>
                           <td width="15%"  bgcolor="#DFDFDF" align="center"><strong>Visiting Directorate</strong></td>
                            ...
                            <td width="15%"  bgcolor="#DFDFDF" align="center"><strong>Scheduled Visit Date</strong></td>                            
...
?>						 
		...
		<tr>
			...
			?>
                            ...
                            <a href="<?php echo $_SERVER['PHP_SELF']; ?>?action=search_foreigner_pass&page=<?php if(isset($_REQUEST['page'])) echo $_REQUEST['page']; else echo 1; 		 							?>&out=true&passID=<?php echo $result_array[$i]['rowID'];?>">Out</a>
		    <?php 
				   }
				   else{
				   		echo "N/A";
            ...
            <td bgcolor="#EEEEEC" align="center"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?action=pass_details_foreigner&passID=<?php echo $result_array[$i]['rowID'];?>">Detail</a></td> 		        </tr>
<?php
		}
?>  
				<tr>
...
<?php
		...
		for($page = 1; $page <= $maxPage; $page++)
		{
		   ...
		   {
			  $nav .= " <a href=\"$self?action=search_foreigner_pass&page=$page\">$page</a> ";
		   } 
		}
		...
		{
		   $page  = $pageNum - 1;
		   $prev  = " <a href=\"$self?action=search_foreigner_pass&page=$page\">[Prev]</a> ";
		
		   $first = " <a href=\"$self?action=search_foreigner_pass&page=1\">[First Page]</a> ";
		} 
		else
		{
		...
		{
		   $page = $pageNum + 1;
		   $next = " <a href=\"$self?action=search_foreigner_pass&page=$page\">[Next]</a> ";
		
		   $last = " <a href=\"$self?action=search_foreigner_pass&page=$maxPage\">[Last Page]</a> ";
		} 
		else
		{
